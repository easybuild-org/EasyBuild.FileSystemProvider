...
| commitMsgFile :: [] ->
    ...
    | _ ->
        printfn "Invalid commit message format, expected a commit message with a tag line"

        exit 1

| _ ->
    printfn "Invalid arguments, expected a single argument with the path to the commit message file"
